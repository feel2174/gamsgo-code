...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "개인 간 거래는 결제 후 계정을 안 주거나 며칠 만에 끊겨도 환불받을 곳이 없는 경우가 많습니다. 겜스고는 150개국 1,000만 명 이상이 이용 중이고 겜스고 플랫폼 공개 평점 4.8(3,674건)인 만큼 검증된 판매자와 거래하며, 문제가 생기면 24시간 안에 환불을 보장해요.",
  },
];
