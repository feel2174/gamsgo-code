...
const Contact = () => {
  ...
  return (
    <div className="page-wrapper">
      <Helmet>
        <title>문의하기 | Frontend Note</title>
        <meta name="description" content="Frontend Note 운영자에게 콘텐츠 오류 신고, 제휴 문의, 개인정보 관련 요청을 보낼 수 있는 연락처 안내 페이지입니다." />
      </Helmet>
      ...
      <div className="page-container">
        ...
        <div className="content">
          ...
          <div className="contact-card">
            ...
            <a className="submit-btn contact-mail-link" href={`mailto:${contactEmail}?subject=Frontend Note%20문의`}>이메일 보내기</a>
          </div>
