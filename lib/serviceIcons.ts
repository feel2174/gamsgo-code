...
export const SERVICE_ICONS: Record<ServiceId, ServiceIcon> = {
  ...
  tving: { kind: "letter", letter: "T", hex: "FF0558" },
  watcha: { kind: "letter", letter: "W", hex: "FF0558" },
  wavve: { kind: "letter", letter: "W", hex: "1D2C54" },
  duolingo: { kind: "brand", path: siDuolingo.path, hex: siDuolingo.hex },
  grammarly: { kind: "brand", path: siGrammarly.path, hex: siGrammarly.hex },
  elevenlabs: { kind: "brand", path: siElevenlabs.path, hex: siElevenlabs.hex },
  "envato-elements": { kind: "brand", path: siEnvato.path, hex: siEnvato.hex },
  klingai: { kind: "letter", letter: "K", hex: "0F172A" },
  miricanvas: { kind: "letter", letter: "미", hex: "6C5CE7" },
  scribd: { kind: "letter", letter: "S", hex: "1A7A5E" },
  updf: { kind: "letter", letter: "U", hex: "3478F6" },
  vidiq: { kind: "letter", letter: "vQ", hex: "EF3C55" },
  coursera: { kind: "brand", path: siCoursera.path, hex: siCoursera.hex },
  deezer: { kind: "brand", path: siDeezer.path, hex: siDeezer.hex },
  medium: { kind: "brand", path: siMedium.path, hex: siMedium.hex },
  qobuz: { kind: "letter", letter: "Q", hex: "1B1B1B" },
};
