...
export const OBJECTION_FAQS = [
  {
    question: "이거 사기 아니에요?",
    answer:
      "겜스고는 전 세계 150개국에서 1,000만 명 이상이 이용 중이고, 겜스고 플랫폼 공개 평점도 4.8점(3,674건)이에요(해외 독립 리뷰 플랫폼 Trustpilot 기준으로는 4.0/5.0). 결제 즉시 계정이 발송되고, 문제가 생기면 24시간 안에 환불도 받을 수 있어서 걱정하시는 것보다 훨씬 안전하게 운영되고 있어요.",
  },
  {
